...
function MediaSelectionUI(props) {
                ...
                props.haveAdd && 
                    <div>
                        <div className={classes.spacing30}>
                            <FilledInput
                                type="text"
                                onChange={ e => {props.sendData(e); props.sendURL(e) }}
                                //onChange={sendURL}
...
export default MediaSelectionUI;